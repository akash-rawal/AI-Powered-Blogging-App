    ...
    <BlogLayout>
      {blogPostData && (
        <>
          ...
          <div className="grid grid-cols-12 gap-8 relative mx-10">
            <div className="col-span-12 md:col-span-8 relative mx-3">
              ...
              <div className="flex items-center gap-1 flex-wrap mt-3 mb-5">
                ...
                <div className="flex items-center flex-wrap gap-2">
                  {blogPostData.tags.slice(0, 3).map((tag, index) => (
                    <button
                      key={index}
                      className="bg-sky-200/50 text-sky-800/80 text-xs font-medium px-3 py-1.5 rounded-full  text-nowrap cursor-pointer "
                      onClick={(e) => {
                        e.stopPropagation();
                        navigate(`/tag/${tag}`);
                      }}
                ...
                <button
                  className="flex items-center gap-2 bg-linear-to-r from-sky-500 to-cyan-400  text-xs  text-white px-3 py-1.5 rounded-full text-nowrap cursor-pointer hover:scale-[1.02] transition-all my-1"
