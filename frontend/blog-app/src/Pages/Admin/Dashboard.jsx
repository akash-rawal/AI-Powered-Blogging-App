...
const Dashboard = () => {
  ...
  return (
    <DashboardLayout activeMenu="Dashboard">
      {dashboardData && (
        <>
          <div className="bg-white p-6 rounded-2xl shadow-md shadow-gray-100 border-gray-200/50 mt-5">
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 my-4 md:my-6">
            <div className="col-span-12 md:col-span-7 bg-white p-4 rounded-2xl shadow-md shadow-gray-100 border border-gray-200/50">
