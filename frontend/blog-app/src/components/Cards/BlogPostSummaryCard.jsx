   ...
   >
     ...
     <div className="flex-1">
       ...
       <div className="flex items-center gap-2.5 mt-2 flex-wrap ">
         ...
         <button
         className="hidden md:group-hover:flex items-center gap-2 text-xs text-rose-500 font-medium bg-rose-50 px-3 py-1 rounded text-nowrap border border-rose-100 hover:border-rose-200 cursor-pointer group-hover:flex"
         onClick={(e) => {
           e.stopPropagation();
           onDelete();
         }}
