...
const CoverImageSelector = ({ image, setImage, preview, setPreview }) => {
  ...
  return (
    <div className="mb-6">
      ...
      {!image && !preview ? (
        <div
          className="w-full h-56 flex flex-col items-center justify-center gap-2 bg-gray-50/50 border border-dashed border-gray-300 rounded-md cursor-pointer relative"
